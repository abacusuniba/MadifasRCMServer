...
@Entity
@Table(name="percentualec")
//@JsonIdentityInfo(generator = ObjectIdGenerators.IntSequenceGenerator.class, property = "@id")
public class PercentualeCollaboratore extends DTOBase implements Comparable<PercentualeCollaboratore>{
...
//		String stringForFilter = nome;
	...
	@Override
	public int compareTo(PercentualeCollaboratore o) {
