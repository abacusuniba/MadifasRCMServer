...
@JsonIdentityInfo(
		  ...
		  property = "id")
public class RigaProdotto extends Riga/* / implements Comparable<RigaProdotto>/**/{

	
	private SchedaNetto scheda;

	private double prezzo=0;

	private int quantita;

	public SchedaNetto getScheda() {
		return scheda;
	}


	public void setScheda(SchedaNetto scheda) {
		this.scheda = scheda;
	}
