...
public class DocumentoComparator implements Comparator<DocumentoBase> {
	@Override
    public int compare(DocumentoBase a, DocumentoBase b) {
		
        int compare1 = 0;
        
        int compare5 = 0;
		
        compare1 = a.getData().compareTo(b.getData())*(-1);
		try {
	        
	         compare5 = a.getDatarev().compareTo(b.getDatarev())*(-1);
