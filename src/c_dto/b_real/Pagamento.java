...
public class Pagamento extends Primary{
...
//	}
	...
	private ArrayList<DescrizionePagamento> descrizioni=new ArrayList<>();
...
//	}
	...
	public ArrayList<DescrizionePagamento> getDescrizioni() {
		return descrizioni;
	}

	public void setDescrizioni(List<DescrizionePagamento> descrizioni) {
...
//		int res = String.valueOf(getNome()).compareTo(String.valueOf(n.getNome()));// + super.compareTo(o);
	...
	public boolean contains(Pagamento elem) {
