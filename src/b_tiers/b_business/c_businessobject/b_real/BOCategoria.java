...
public class BOCategoria extends NewBOBase<Categoria>{
	
	
	public BOCategoria() {
		startMemory();
		
//		String query = "select id, tipo from tipodocumento";// where stato=1;";
...
//		TipoDocumento m = (TipoDocumento) getMemory().get(o.getId());
...
////		String query = "select id, Categoria from Categoria;";
////		ResultSet rs = DAO.executeQuery(query);
////		
////		try {
////			while(rs.next()){
...
////				n.setId(rs.getInt("id"));
////				n.setNome(rs.getString("Categoria"));
////				addElement(n);
////			}
////		} catch (SQLException e) {
////			// TODO Auto-generated catch block
...
////	@Override
////	public void read(DTOBase o) {
////		Categoria m = (Categoria) getMemory().get(o.getId());
////		Categoria n=(Categoria) o;
////		
////		if (m.isEmpty()){
////			ResultSet rs =DAO.read(m);
