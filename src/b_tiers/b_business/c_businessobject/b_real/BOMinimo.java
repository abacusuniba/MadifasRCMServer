...
public class BOMinimo extends NewBOBase<Minimo>{
	
	
	public BOMinimo() {
		startMemory();
//		
//		String query = "select id, minimo from minimo";// where stato=1;";
...
//		Minimo m = (Minimo) getMemory().get(o.getId());
//		Minimo n=(Minimo) o;
//		
//		if (m.isEmpty()){
