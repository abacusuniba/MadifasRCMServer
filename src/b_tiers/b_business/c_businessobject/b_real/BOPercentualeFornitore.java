...
public class BOPercentualeFornitore extends NewBOBase<PercentualeFornitore>{
	
	
	public BOPercentualeFornitore() {
		startMemory();
		
//		String query = "select id, percentuale from percentualef";// where stato=1;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				PercentualeFornitore n = new PercentualeFornitore();
...
//		PercentualeFornitore m = (PercentualeFornitore) getMemory().get(o.getId());
//		PercentualeFornitore n=(PercentualeFornitore) o;
//		
//		if (m.isEmpty()){
