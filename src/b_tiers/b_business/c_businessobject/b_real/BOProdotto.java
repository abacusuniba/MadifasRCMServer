...
public class BOProdotto extends NewBOBase<Prodotto>{
	
	
	public BOProdotto() {
		startMemory();
//		
//		String query = "select id, nome from Prodotto";// where stato=1;";
...
//		Prodotto m = (Prodotto) getMemory().get(o.getId());
//		Prodotto n=(Prodotto) o;
//		
//		if (m.isEmpty()){
...
//			try {
//				rs.next();
//				n.setNome(rs.getString("Prodotto"));
