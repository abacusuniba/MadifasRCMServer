...
public class BOForma extends NewBOBase<FormaGiuridica>{
	
	
	public BOForma() {
		startMemory();
		
//		String query = "select id, nome, stato from forma";// where stato=1;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				FormaGiuridica n = new FormaGiuridica();
...
//		FormaGiuridica n = (FormaGiuridica) o;
...
//		FormaGiuridica m = (FormaGiuridica) getMemory().get(o.getId());
//		FormaGiuridica n=(FormaGiuridica) o;
//		
//		if (m.isEmpty()){
