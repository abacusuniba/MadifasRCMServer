...
public class BOConsorzio extends NewBOBase<Consorzio>{
	
	
	public BOConsorzio() {
		startMemory();
		
//		String query = "select id, nome from consorzio";// where stato=1;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				Consorzio n = new Consorzio();
...
//		Consorzio m = (Consorzio) getMemory().get(o.getId());
//		Consorzio n=(Consorzio) o;
//		
//		if (m.isEmpty()){
