...
public class BOUM extends NewBOBase<UM>{
	
	
	public BOUM() {
		startMemory();
		
////		String query = "select id, Um from Um";// where stato=1;";
//		String query = "select id, Um from Um";
