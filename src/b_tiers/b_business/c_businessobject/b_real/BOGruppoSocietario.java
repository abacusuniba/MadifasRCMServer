...
public class BOGruppoSocietario extends NewBOBase<GruppoSocietario>{
	
	
	public BOGruppoSocietario() {
		startMemory();
		
//		String query = "select id, nome from gruppoaziende";// where stato=1;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				GruppoAziende n = new GruppoAziende();
...
//		GruppoSocietario n = (GruppoSocietario) o;
...
//		GruppoAziende m = (GruppoAziende) getMemory().get(o.getId());
//		GruppoAziende n=(GruppoAziende) o;
//		
//		if (m.isEmpty()){
