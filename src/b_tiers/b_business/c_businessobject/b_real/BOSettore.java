...
public class BOSettore extends NewBOBase<Settore>{
	
	
	public BOSettore() {
		startMemory();
//		
//		String query = "select id, nome from Settore";// where stato=1;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				Settore n = new Settore();
...
////		Settore m = (Settore) getMemory().get(o.getId());
////		Settore n=(Settore) o;
////		
////		if (m.isEmpty()){
