...
@Deprecated
public class BOMovimentazione extends NewBOBase<Integer /*Movimentazione*/>{
	
	public BOMovimentazione() {
//		startMemory();
//		
//		String query = "select id, tipo from movimentazione;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				Movimentazione n = new Movimentazione();
//				n.setId(rs.getInt("id"));
//				n.setNome(rs.getString("tipo"));
//				addElement(n);
//			}
...
////		Movimentazione n = (Movimentazione) o;
...
//		Movimentazione m = (Movimentazione) getMemory().get(o.getId());
//		Movimentazione n=(Movimentazione) o;
//		
//		if (m.isEmpty()){
