...
public class BOSottoGruppoProdotto extends NewBOBase<SottoGruppoProdotto>{
	
	
	public BOSottoGruppoProdotto() {
		startMemory();
		
////		String query = "select id, SottoGruppo from SottoGruppo";// where stato=1;";
//		String query = "select id, SottoGruppo from SottoGruppo;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				SottoGruppoProdotto n = new SottoGruppoProdotto();
//				n.setId(rs.getInt("id"));
//				n.setNome(rs.getString("SottoGruppo"));
//				addElement(n);
//			}
...
//		SottoGruppoProdotto m = (SottoGruppoProdotto) getMemory().get(o.getId());
//		SottoGruppoProdotto n=(SottoGruppoProdotto) o;
//		
//		if (m.isEmpty()){
