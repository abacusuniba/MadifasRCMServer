...
public class BOTrasporto extends NewBOBase<Trasporto>{
	
	
	public BOTrasporto() {
		startMemory();
//		
//		String query = "select id, nome from trasporto";// where stato=1;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				Trasporto n = new Trasporto();
...
//		Trasporto m = (Trasporto) getMemory().get(o.getId());
//		Trasporto n=(Trasporto) o;
//		
//		if (m.isEmpty()){
