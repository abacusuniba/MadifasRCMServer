...
public class BOPagamento extends NewBOBase<Pagamento>{
	
	
	public BOPagamento() {
		startMemory();
//		
//		String query = "select id, nome from pagamento";// where stato=1;";
//		ResultSet rs = DAO.executeQuery(query);
//		
//		try {
//			while(rs.next()){
//				Pagamento n = new Pagamento();
...
//		Pagamento m = (Pagamento) getMemory().get(o.getId());
//		Pagamento n=(Pagamento) o;
//		
//		if (m.isEmpty()){
