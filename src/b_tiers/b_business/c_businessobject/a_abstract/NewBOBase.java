...
public abstract class NewBOBase<T> extends BaseNewBOBase<T>{
//	private final Class<?> myClass=(Class<? extends DTOBase>) ((ParameterizedType)this.getClass().getGenericSuperclass()).getActualTypeArguments()[0];
...
//	public final void reload(DTOBase o) {
//////	Nazione n=(Nazione) o;
//////	n.setStato(Stato.Archiviato);
////	removeElement(o);
//	
