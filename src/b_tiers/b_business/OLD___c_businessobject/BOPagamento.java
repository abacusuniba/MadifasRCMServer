...
import c_dto.OLD___b_real.Pagamento;

//import java.lang.reflect.ParameterizedType;
//import java.lang.reflect.Type;


public class BOPagamento extends BOBase<Pagamento>{
...
//	}
//
//	public void update(Pagamento c) {
//		getDao().update(c);		
//	}

	public void delete(Pagamento c) {
//		getDao().delete(c);
		
		getMemory().remove(c.getId());
		if (!c.isLoaded())
		{
			c=(Pagamento) getDao().read(c);
