...
import c_dto.OLD___b_real.Provincia;

//import java.lang.reflect.ParameterizedType;
//import java.lang.reflect.Type;


public class BOProvincia extends BOBase<Provincia>{
...
//	}
//
//	public void update(Provincia c) {
//		getDao().update(c);		
//	}

	public void delete(Provincia c) {
//		getDao().delete(c);
		
		getMemory().remove(c.getId());
		if (!c.isLoaded())
		{
			c=(Provincia) getDao().read(c);
