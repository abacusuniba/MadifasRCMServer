...
import c_dto.OLD___b_real.PercentualeFornitore;
...
public class BOPercentualeFornitore extends BOBase<PercentualeFornitore>{
//	private Class<T> clazz;	
	
	@SuppressWarnings("unchecked")
	public BOPercentualeFornitore(){
		setDao();
...
//	public void add(PercentualeFornitore c) {
//		getDao().create(c);
//		
//		getMemory().put(c.getId(), c);
//	}
//
//	public void update(PercentualeFornitore c) {
//		getDao().update(c);		
//	}

	public void delete(PercentualeFornitore c) {
//		getDao().delete(c);
		
		getMemory().remove(c.getId());
		if (!c.isLoaded())
		{
			c=(PercentualeFornitore) getDao().read(c);
