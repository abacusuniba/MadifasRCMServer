...
import c_dto.OLD___b_real.Segnalatore;

//import java.lang.reflect.ParameterizedType;
//import java.lang.reflect.Type;


public class BOSegnalatore extends BOBase<Segnalatore>{
...
//	}
//
//		public void update(Segnalatore c) {
//			getDao().update(c);
//		}

		public void delete(Segnalatore c) {
//				getDao().delete(c);
				
				getMemory().remove(c.getId());
				if (!c.isLoaded())
				{
					c=(Segnalatore) getDao().read(c);
