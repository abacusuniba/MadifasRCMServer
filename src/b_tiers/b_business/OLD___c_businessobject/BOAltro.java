...
import c_dto.OLD___b_real.Altro;
...
public class BOAltro extends BOBase<Altro>{
...
//	}
//
//	public void update(Altro c) {
//		getDao().update(c);
//	}

	public void delete(Altro c) {
//		getDao().delete(c);
		
		getMemory().remove(c.getId());
		if (!c.isLoaded())
		{
			c=(Altro) getDao().read(c);
