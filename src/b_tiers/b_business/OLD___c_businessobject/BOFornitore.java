...
public class BOFornitore extends BOBase<Fornitore>{
...
//	public void add(Fornitore f){
//		getDao().create(f);
//		
//		getMemory().put(f.getId(), f);
//		
//	}
//
//	public void update(Fornitore c){
////		try{
//		
//		getDao().update(c);
////		}catch(Exception e){
...
//	}
	...
	public void delete(Fornitore c){
//		getDao().delete(c);
		
		getMemory().remove(c.getId());
		if (!c.isLoaded())
		{
			c=(Fornitore) getDao().read(c);
