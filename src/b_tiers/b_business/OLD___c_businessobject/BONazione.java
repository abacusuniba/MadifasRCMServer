...
import c_dto.OLD___b_real.Nazione;

//import java.lang.reflect.ParameterizedType;
//import java.lang.reflect.Type;


public class BONazione extends BOBase<Nazione>{
...
//	}
//
//	public void update(Nazione c) {
//		getDao().update(c);		
//	}

	public void delete(Nazione c) {
//		getDao().delete(c);
		
		getMemory().remove(c.getId());
		if (!c.isLoaded())
		{
			c=(Nazione) getDao().read(c);
