...
import c_dto.OLD___b_real.PercentualeCollaboratore;;
...
public class BOPercentualeCollaboratore extends BOBase<PercentualeCollaboratore>{
...
//	public void add(PercentualeCollaboratore c) {
//		getDao().create(c);
//		
//		getMemory().put(c.getId(), c);
//	}
//
//	public void update(PercentualeCollaboratore c) {
//		getDao().update(c);		
//	}

	public void delete(PercentualeCollaboratore c) {
//		getDao().delete(c);
		
		getMemory().remove(c.getId());
		if (!c.isLoaded())
		{
			c=(PercentualeCollaboratore) getDao().read(c);
